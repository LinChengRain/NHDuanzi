...
class NHNewViewController: UIViewController {
    ...
    func addViews() {
        ...
        videoVC.current_path = new_path + movie_url
        videoVC.title = "视频"
        let photoVC = PhotoViewController()
        photoVC.current_path = new_path + photo_url
        photoVC.title = "图片"
        let jokeVC = JokeViewController()
        jokeVC.current_path = new_path + joke_url
        jokeVC.title = "段子"
